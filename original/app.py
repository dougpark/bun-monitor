...
# New function to fetch fresh stats without cache
def get_fresh_stats():
    return {
        "nvidia": run_nvidia_smi(),
        "sys": run_system_info(),
...
# New route to bypass cache and return fresh readings
@app.route('/api/fresh_stats')
def fresh_stats_api():
    return jsonify(get_fresh_stats())
